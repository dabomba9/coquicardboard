...
export const metadata: Metadata = {
  title: "Killebrew Vault — Harmon Killebrew's playing-era cards",
  description: "Browse Harmon Killebrew's playing-era card catalog (1955–1976) — search, filter, follow market value, and track what you own.",
  alternates: { canonical: "/killebrew-vault" },
  openGraph: {
    title: "Killebrew Vault — Harmon Killebrew's playing-era cards · Coqui Cardboard",
    description: "Browse Harmon Killebrew's playing-era card catalog (1955–1976) — search, filter, follow market value, and track what you own.",
    url: "/killebrew-vault",
    type: "website",
  },
...
export default async function KillebrewVaultPage({
  searchParams,
}: {
  ...
  const [catalog, holdings] = await Promise.all([
    getVaultCatalog("killebrew-vault"),
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10">
      ...
      <p className="mt-1 text-sm text-muted">
        ...
        playing-era cards (1955–1976) · <span className="font-data text-base text-foreground">{withImage.toLocaleString()}</span> with images.
      ...
      <VaultExplorer
        ...
        placeholderArt={legendArtForCatalog("killebrew-vault")}
        player={playerForCatalog("killebrew-vault")}
      />
    </div>
  );
}
